...
| 前景 | 墨 | `#38342c` | 墨色，不死黑 |
| 注释 | 墨痕 | `#97907f` | 斜体，融进纸里 |
| keyword | 青花 | `#356a8d` | 青花瓷蓝，结构骨架 |
| type | 天青 | `#3a7b71` | 汝窑天青，最高级的含蓄 |
| string | 竹青 | `#5d7a39` | 竹皮之绿，内容/数据 |
| function | 缃色 | `#9c6a26` | 浅黄绢，书卷暖意，调用点 |
| number | 赭石 | `#9a5730` | 国画矿物，常量 |
| error | 朱砂 | `#b3433a` | 印泥红，**只给错误用** |
| builtin | 黛紫 | `#66518c` | 画眉之黛，特殊/内建 |
| field | 胭脂 | `#97485f` | 柔暖，对象字段 |
